...
public class HonoIslandActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hono_island);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_hono);
        setSupportActionBar(toolbar);

        TabLayout tabLayout = (TabLayout) findViewById(R.id.tab_layout_hono);
        ...
        final ViewPager viewPager = (ViewPager) findViewById(R.id.pager_hono);
